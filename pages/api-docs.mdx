...
* <b>workspace_id</b> (integer): The ID of your Roblox workspace.
* <b>username</b> (string): The username of the target user.
* <b>user_id</b> (integer): The user ID of the target user.

For the Set Rank and Shout endpoints, additional parameters are required:

* <b>rank</b> (integer): The desired rank for the Set Rank endpoint.
* <b>shout_text</b> (string): The text of the shout message for the Shout endpoint.
